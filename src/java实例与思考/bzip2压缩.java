...
abstract class BZip2Utils {
	 ...
	 * @throws Exception
	 */
	public static void compress1(String path) throws Exception {
		File[] file = new File(path).listFiles();
		FileOutputStream fos = new FileOutputStream(path + EXT);
		BZip2CompressorOutputStream gos = new BZip2CompressorOutputStream(fos);
...
public class bzip2压缩 {
	public static void main(String[] args) throws Exception {

		File tempFile = new File("F:\\test\\install");
		BZip2Utils.compress1("F:\\test\\test");
	}
}
