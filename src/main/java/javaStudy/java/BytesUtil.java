...
public class BytesUtil {
     ...
     *
     * @param sOldStr元原字符串
     * @param SupplyWay补充方式  ：0前补；1后补；其它 不变
     * @param SupplyChar补充字符
     * @param SupplyNum需占满位数
     */
    public static String supplyString(String sOldStr, int SupplyWay, String SupplyChar, int SupplyNum) {
        String sTmp = "";
